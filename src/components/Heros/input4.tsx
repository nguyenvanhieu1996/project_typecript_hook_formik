...
const Input4: React.FC<Props> = ({ form }) => {
    console.log('render input 4')
    ...
    const prefixSelector = getFieldDecorator('prefix4', {
        initialValue: '86',
    })(
...
const WrappedInput4Form = Form.create()(Input4);

export default React.memo(WrappedInput4Form)